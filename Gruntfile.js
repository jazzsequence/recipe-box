module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        cssmin: {
            dist: {
                files: {
                    'assets/css/recipes.min.css': 'assets/css/recipes.css',
                    'assets/css/recipe-import.min.css': 'assets/css/recipe-import.css'
                }
            }
        },
        usebanner: {
            taskName: {
                ...
                files: {
                    src: ['assets/css/recipes.min.css'],
                    src: ['assets/css/recipe-import.min.css']
                }
            }
        }
    });
